...
// ⚠️ Si ton UI propose aussi "Autre" pour le sexe, ajoute-le ici.
...
/** Aligne avec l’UI : 'Vous-même' | 'Institution' | 'Autre' */
...
export const applicationSchema = z.object({
  ...
  /** ✅ ici c'est bien "institution" (et non "institutionFinancement") */
...
.refine(
  (data) =>
    data.langues.every(
      (l) => typeof data.niveaux[l] === 'string' && (data.niveaux[l] as string).trim() !== ''
    ),
...
/** ✅ corrige la pick-list : on prend "institution" (pas ...Financement) */
